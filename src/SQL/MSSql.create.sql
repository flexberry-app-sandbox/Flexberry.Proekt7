...
CREATE TABLE [ПриходУход] (
	 ...
	 [Расписание] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [Ученик] (
	 ...
	 [ПриходУход] UNIQUEIDENTIFIER  NOT NULL,

	 [Просмотр] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ТчМестоУч] (
	 ...
	 [МестоУч] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [СправУч] (
	 ...
	 [Номер] UNIQUEIDENTIFIER  NOT NULL,
